...
from src.services.paraphrase_service_nokw import process_question
...
async def run_test_case(test: dict, case_num: int, debug_dir: Path) -> None:
    ...
    try:
        ...
        # Save debug output
        debug_file = debug_dir / f"paraphrase_nokw_test_{case_num}.json"
...
async def test_paraphrase():
    ...
    print("\n🧪 Starting Paraphrase Service Tests (No Keywords)")
    print("=" * 50)
